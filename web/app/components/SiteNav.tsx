...
export default function SiteNav(){
  ...
  return <header className="nav"><div className="shell nav-inner">
    ...
    <nav className="nav-links" aria-label="Main navigation"><Link href="/">Home</Link><Link href="/profiles">Profiles</Link><Link href="/community">Community</Link><Link href="/docs">Docs</Link><Link href="/download">Download</Link></nav>
